...
<body xmlns="http://www.w3.org/1999/html">
    ...
    <form  id="connexion" name="connexion" method="POST" action="/signIn" >
        <div class="news">
            <div class="mb-3">
                <label class = "form_col" for="user_name">Nom d'utilisateur:</label><br> <input type="text" name="user_name" id="user_name" required>
			</div>
            <div class="mb-3">
            ...
            <p style = "color: white">Vous n'avez pas de compte? S'inscrire <a href = "inscription">ICI</a></p> 
