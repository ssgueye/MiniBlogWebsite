...
<body xmlns="http://www.w3.org/1999/html">
    ...
    <p><h2>Création d'un nouveau article...</h2></p>

    <form  id="connexion" name="connexion" method="POST" action="/newArticlePost" >
        <div class="news">
            <div class="mb-3">
                <label class = "form_col" for="title">Titre:</label><br> <input type="text" name="title" id="title" maxlenghth = "100"  required>	
			</div>

            <div class="mb-3">
                <label class = "form_col" for="author">Nom auteur:</label><br> <input type="text" name="author" id="author" maxlenghth = "100" required>
			</div>

            <div class="mb-3">
                <label class = "form_col" for="content">Contenu:</label><br> <textarea name="content" id="content" maxlenghth = "2000"></textarea required>
            </div>
            <p> <input type="reset" class="btn btn-primary value="Réinitialiser"></p>
